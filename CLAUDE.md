...
npm test                  # runs test/run.js - unit tests for strategy_rise_fall.js / strategy_accumulator.js / strategy_even_odd.js / memory.js's stake-scaling math / driver.js's pickHybridBucket
